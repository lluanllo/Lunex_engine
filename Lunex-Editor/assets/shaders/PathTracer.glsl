...
layout(std140, binding = 15) uniform CameraData {
    ...
    vec4  u_IBLTint;            // 16   offset 192  (xyz=tint, w=enableDenoiser) → 208 total
};

// ============================================================================
// TRIANGLES SSBO (binding = 20, std430)
// RTTriangleGPU: 8 × vec4 = 128 bytes
// ============================================================================
struct RTTriangle {
...
// ============================================================================
// BILATERAL FILTER DENOISER — edge-preserving blur on accumulated image
...
vec3 BilateralDenoise(ivec2 pixel, ivec2 screenSize, vec3 centerColor, float strength) {
    // Kernel radius scales with strength (1–3 pixels)
